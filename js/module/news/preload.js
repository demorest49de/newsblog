export const preload = {
    circleArrows:
        '<svg class="preload" width="166" height="120" viewBox="0 0 166 120" fill="none" xmlns="http://www.w3.org/2000/svg">\n' +
    ...
    show() {
        this.overlay.className = 'preload__overlay';
        this.overlay.innerHTML = this.overlay.innerHTML = this.circleArrows;
